 ...
 ?>
	...
	<body>
		...
		<section class="start-logo">
			<h1 class="loginLogo">Zona</h1>
		</section>

		<section class="start-logo">
			<h2>welcome to <span class="zona-color">zona</span></h2>

			<h3>your social <span class="zona-color">music</span> platform</h3>

			<a href="login.php"><input type="button" value="login" class="login-button"></a>
